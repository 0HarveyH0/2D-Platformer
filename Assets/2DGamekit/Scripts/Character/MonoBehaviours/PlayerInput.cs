...
namespace Gamekit2D
{
    public class PlayerInput : InputComponent, IDataPersister
    {
        ...
        public InputButton MeleeAttack = new InputButton(KeyCode.Mouse1, XboxControllerButtons.X);
        public InputButton RangedAttack = new InputButton(KeyCode.Mouse0, XboxControllerButtons.B);
